...
parser.add_argument("-s", "--scriptsDirectory", help="Scripts directory.", default="stringtie_after_merge")
parser.add_argument("-i", "--inputDirectory", help="Input directory with BAM files.", default="../results/star2pass")
parser.add_argument("-o", "--outputDirectory", help="Output directory with stringtie results.", default="../results/stringtie_after_merge")
parser.add_argument("-g", "--gtfFile", help="GTF file generated with stringtie --merge.", default="../results/stringtie_merge/merged.gtf")
...
gtfFile = os.path.abspath(args.gtfFile)
