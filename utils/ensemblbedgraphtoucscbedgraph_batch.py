...
parser.add_argument("-d", "--dictionary", help="Tab-delimited text file with the Ensembl symbols and the corresponding UCSC symbols. Default=/gs/project/feb-684-aa/genomes/Drosophila_melanogaster/Ensembl/BDGP5/Annotation/Genes/ucsctoEnsembl.txt", default="/gs/project/feb-684-aa/genomes/Drosophila_melanogaster/Ensembl/BDGP5/Annotation/Genes/ucsctoensemblchromsomes.dict")
