...
parser.add_argument("-t", "--stranded", help="Stranded files.", choices=["yes", "no", "y", "n"], default="no")
parser.add_argument("-q", "--submitJobsToQueue", help="Submit jobs to queue immediately.", choices=["yes", "no", "y", "n"], default="no")
parser.add_argument("-x", "--extension", help="Extension of BAM files on which to run featureCounts", default="")
...
for sample in samples:
    for strand in strands:
        ...
        script.write("-ibam " + os.path.relpath(os.path.join(inputDirectory, sample, sample + strand + extension + ".bam")) + " \\\n")
        if institute == "Ensembl":
