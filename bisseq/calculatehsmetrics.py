...
parser.add_argument("-s", "--scriptsDirectory", help="Scripts directory. DEFAULT=calculatehsmetrics", default="calculatehsmetrics")
...
parser.add_argument("-o", "--outputDirectory", help="Output directory with filterd BAM files. DEFAULT=../results/calculatehsmetrics", default="../results/calculatehsmetrics")
